...
-- Generic floating position (exclude anonymous popup menus)
hl.window_rule({ match = { float = true, class = "^.+$" }, center = true, persistent_size = true })
...
hl.window_rule({ match = { title = "^espanso$" }, float = true, center = true })
